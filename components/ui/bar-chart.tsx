...
/** biome-ignore-all lint/suspicious/noExplicitAny: Recharts types are not well-typed */
...
const Legend = React.forwardRef<HTMLOListElement, LegendProps>((props, ref) => {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: change setHasScroll
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: change checkScroll
  React.useEffect(() => {
    const scrollable = scrollableRef?.current;
  ...
  return (
    ...
    >
      <div
        ref={scrollableRef}
        // biome-ignore lint/a11y/noNoninteractiveTabindex: this div is clickable
        tabIndex={0}
        className={cn(
          'flex h-full',
          enableLegendSlider
      ...
      >
        {categories.map((category, index) => (
          <LegendItem
            key={`item-${
              // biome-ignore lint/suspicious/noArrayIndexKey: items has some keys
              index
            }`}
            name={category}
        ...
        <ResponsiveContainer>
          ...
          >
            ...
            <YAxis
              ...
              axisLine={false}
              tickLine={false}
              minTickGap={0} // 追加：目盛り間の最小隙間を0に
              interval={0} // 追加：すべての目盛りを表示
              fill=""
              stroke=""
              className={cn(
                // base
